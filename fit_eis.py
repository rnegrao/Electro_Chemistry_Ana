...
for i in file_list:
        ...
        #first circle
        params.add('R1', value=R1, min=R1-n*R1, max=R1+n*R1, vary=True)
        params.add('Q1', value=Q1, min=Q1-n*Q1, max=Q1+n*Q1, vary=True)
        params.add('n1', value=n1, min=n1-n*n1, max=n1+n*n1, vary=True)
        #second circle
        ...
        plt.plot(Re, Im, 'o', label='EIS Measurements '+legend_string[j], markersize=4,color=hex_colors[1])
        j=j+1
